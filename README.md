...
- The traffic was captured on the POX controller virtual machine using Tcpdump.
- The CICFlowMeter tool was used to extract flow features from the captured traffic.
