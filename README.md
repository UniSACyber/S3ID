...
- **Attack traffic**: A malicious host (h25) connected to the ground station generated the attack traffic against the controller. Several attacks were used to generate the attack traffic, including a port scan attack and two types of SYN flood attacks, a generic (DoS attack) and a random source flood (DDoS attack), referred to as a SYN flow flood attack in this project.
