...
- **Attack traffic**: Several attacks were used to generate the attack traffic, including a port scan attack and two types of SYN flood attacks, a generic and random source flood, referred to as SYN flow flood attack in this project.
    <p align="center">
        <img src="graphics/eoscenario.png" alt="ISL Connectivity Matrix for interval 7" width="400">
    </p>
- The traffic was captured on the POX controller using Tcpdump.
